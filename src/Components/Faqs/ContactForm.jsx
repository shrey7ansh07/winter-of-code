    ...
    <section className="bg-#0a0918 dark:dark">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-2xl">
        ...
        <p className="mb-8 mt-20 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
          ...
          Need details about our Website? Let us know.
        </p>
        <form action="#" className="space-y-8">
          ...
          <div>
            ...
            <input
              ...
              shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium text-center border border-gray-800
             text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-gray-800 focus:ring-4 focus:outline-none 
